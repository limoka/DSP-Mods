...
namespace BlueprintTweaks
{
    public static class Preloader
    {
        ...
        {
            TypeDefinition dataType = new TypeDefinition("BlueprintTweaks", "ReformData",
                TypeAttributes.AnsiClass | TypeAttributes.BeforeFieldInit | TypeAttributes.Public, assembly.MainModule.TypeSystem.Object);
            ...
            MethodDefinition ReformData_ctor_ = new MethodDefinition(".ctor",
