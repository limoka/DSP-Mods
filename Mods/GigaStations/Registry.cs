...
namespace kremnev8
{
    public class Registry
    {
        ...
        public static void Init(string bundleName, string keyword, bool requireBundle, bool requireVerta)
        {
            ...
            var harmony = new Harmony("Registry-" + keyword);

            harmony.PatchAll(typeof(UIBuildMenuPatch));
            harmony.PatchAll(typeof(StorageComponentPatch));
            harmony.PatchAll(typeof(ResourcesPatch));
            harmony.PatchAll(typeof(VertaBufferPatch));
        }
        ...
        {
            int id = FindAvailableID(1000, LDB.strings, strings);
    ...
    static class ResourcesPatch
    {
        ...
        public static bool Prefix(ref string path, Type systemTypeInstance, ref UnityEngine.Object __result)
        {
            if (path.Contains(Registry.keyWord) && Registry.bundle != null)
            {
                ...
                if (Registry.bundle.Contains(path + ".tif"))
                {
                    UnityEngine.Object mySprite =
                        Registry.bundle.LoadAsset(path + ".tif", systemTypeInstance);
