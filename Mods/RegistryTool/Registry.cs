...
namespace SignalNetwork
{
    public class Registry
    {
        ...
        public static Material CreateMaterial(String shaderName, String materialName, String color, String[] textures)
        {
            ...
            for (int i = 0; i < textures.Length; i++)
            {
                ...
                if (bundle == null)
                {
                    LogSource.LogError("Error! function CreateMaterial was used and asked for textures, but asset bundle IS NOT loaded. This will cause issues!");
                }
                else
                {
                    Texture2D texture = bundle.LoadAsset<Texture2D>(textures[i]);
