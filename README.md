...
4. If you intent to use prefab ingame you also need to properly setup all needed description scripts(Like BuildConditionConfig, SlotConfig, etc scrips). Game uses these scripts to figure out what is what and where
